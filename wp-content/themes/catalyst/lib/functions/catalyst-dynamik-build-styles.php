...
function catalyst_build_dynamik_styles( $child = 'no' )
{
	...
	****************************************/
	...
	$comment_author_link_color = catalyst_get_dynamik( 'comment_author_link_color' );
	$comment_author_link_hover_color = catalyst_get_dynamik( 'comment_author_link_hover_color' );
	
	if( catalyst_get_dynamik( 'comment_author_link_underline' ) == 'On Hover' )
	{
		$comment_author_link_underline_visited = 'none';
		$comment_author_link_underline_hover = 'underline';
	}
	elseif( catalyst_get_dynamik( 'comment_author_link_underline' ) == 'Off Hover' )
	{
		$comment_author_link_underline_visited = 'underline';
		$comment_author_link_underline_hover = 'none';
	}
	elseif( catalyst_get_dynamik( 'comment_author_link_underline' ) == 'Always' )
	{
		$comment_author_link_underline_visited = 'underline';
		$comment_author_link_underline_hover = 'underline';
	}
