...
add_action( 'admin_print_styles', 'catalyst_wp_admin_styles' );
/**
 * Enqueue general WP admin styles.
 *
 * @since 1.5.4
 */
function catalyst_wp_admin_styles()
{
	$catalyst_template_dir = get_template_directory_uri();

	wp_enqueue_style( 'catalyst_admin_css', $catalyst_template_dir . '/lib/css/admin.css', array(), CATALYST_THEME_VERSION );
}
